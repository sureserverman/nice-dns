...
# Write atomically. systemd EnvironmentFile= parses KEY=VALUE pairs with
# optional surrounding single/double quotes; bash `source` does too. Single
# quotes are safest because the bridge values contain spaces and `=`.
umask 077
